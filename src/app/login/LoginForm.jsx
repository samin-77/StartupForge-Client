          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="flex items-center gap-2.5">
              ...
              <input
                ...
                className="input-field py-2.5 text-sm bg-[#0f172a] border-[#1e293b] focus:border-[#6366f1]"
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="relative flex-1">
                <input
                  ...
                  className="input-field py-2.5 text-sm bg-[#0f172a] border-[#1e293b] focus:border-[#6366f1] w-full pr-10"
